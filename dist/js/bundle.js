...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./src/js/base.js\");\n/* harmony import */ var _views_artFullView__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/artFullView */ \"./src/js/views/artFullView.js\");\n//Global app controller\n\n // Rende main view for the first time\n\nObject(_base__WEBPACK_IMPORTED_MODULE_0__[\"renderMainView\"])(_base__WEBPACK_IMPORTED_MODULE_0__[\"sections\"].HOME); // FAMEWORK NAV\n\n_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].frameworkNav.addEventListener('click', e => {\n  e.preventDefault();\n  homeView.updateSelectedFrameworkNav(e);\n}); // MAIN NAV\n\n_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].mainNav.addEventListener('click', e => {\n  // 1) Get section name\n  const section = e.target.dataset.section; // 2) Render the new section view\n\n  Object(_base__WEBPACK_IMPORTED_MODULE_0__[\"renderMainView\"])(section);\n}); // ART THUMBNAILS\n\n_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].dynamicContent.addEventListener('click', e => {\n  // 1) Get art work name\n  const name = e.target.dataset.name.replace('-', ''); // 2) Clear the current dynamic content as we rerender\n\n  Object(_base__WEBPACK_IMPORTED_MODULE_0__[\"fadeElement\"])(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].homePageContent, 'out'); // 3) Add custom class to overide some of the dynamic\n  //    containers base css\n\n  _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].dynamicContent.classList.add('art-full-page'); // 4) Render the full page art view\n\n  _views_artFullView__WEBPACK_IMPORTED_MODULE_1__[\"renderView\"](name);\n}); // HOME link from CONTACT page\n\n_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].homePageContent.addEventListener('click', e => {\n  // 1) Make sure it was the actual home-link that\n  //    was clicked on and not the background\n  if (e.target.id === \"home-link\") {\n    Object(_base__WEBPACK_IMPORTED_MODULE_0__[\"renderMainView\"])(_base__WEBPACK_IMPORTED_MODULE_0__[\"sections\"].HOME);\n  }\n}); // CLOSE BUTTON\n\n_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].dynamicClose.addEventListener('click', e => {\n  // 1) Fade out dynamic content\n  Object(_base__WEBPACK_IMPORTED_MODULE_0__[\"fadeElement\"])(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].dynamicWrapper, 'out'); // 2) Wait second for the fade before clearing the content \n  //    and fading the dynamic content container back in\n\n  setTimeout(function () {\n    Object(_base__WEBPACK_IMPORTED_MODULE_0__[\"clearContent\"])(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].dynamicContent);\n    Object(_base__WEBPACK_IMPORTED_MODULE_0__[\"fadeElement\"])(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].dynamicContent, 'in');\n  }, 1000);\n});\n\n//# sourceURL=webpack:///./src/js/index.js?");
